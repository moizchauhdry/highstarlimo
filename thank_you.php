<?php include('header.php');?>
    <div class="limoking-page-title-wrapper header-style-2-title-wrapper">
        ...
        <div class="limoking-page-title-container container">
            <h1 class="limoking-page-title" style="margin-top:70px;margin-bottom:70px;">Thank you for your request a qoute</h1></div>
    </div>
                                ...
                                <div class="limoking-item-title-wrapper limoking-item  limoking-center-divider limoking-medium ">
                                    <div class="limoking-item-title-container container">
                                        <div class=limoking-item-title-head-inner>
                                            ...
                                            <h3 class="limoking-item-title limoking-skin-title limoking-skin-border" style="color:black;">Thank you</h3>
                                            <div class="limoking-item-title-center-divider limoking-right"></div>
                                        </div>
                                        <div class="limoking-item-title-caption limoking-skin-info" style="color:black;">Our team will contact you soon.</div>
                                    </div>
                                </div>
                            </div>
                            <div class=clear></div>
