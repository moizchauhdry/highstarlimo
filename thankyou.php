<?php include('header.php');?>
    <div class="limoking-page-title-wrapper header-style-2-title-wrapper">
        ...
        <div class="limoking-page-title-container container">
            <h1 class="limoking-page-title" style="margin-top:70px;margin-bottom:70px;">Thank you for your reservation</h1></div>
    </div>
                            ...
                            <div class=limoking-title-item>
                                <div class="limoking-item-title-wrapper limoking-item  limoking-center-divider limoking-medium ">
                                    <div class="limoking-item-title-container container">
                                        ...
                                        <div class="limoking-item-title-caption limoking-skin-info" style="color:black;">You will be contacted shortly.</div>
                                    </div>
                                </div>
                            </div>
                            <div class=clear></div>
