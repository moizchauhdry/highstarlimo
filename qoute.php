...
<div class=content-wrapper>
    <div class=limoking-content>
        <div class="limoking-page-title-wrapper header-style-2-title-wrapper" style="background-image:url(../images/qoute.jpg);">
            <div class=limoking-page-title-overlay></div>
            <div class="limoking-page-title-container container">
                <h1 class="limoking-page-title" style="margin-top:70px;margin-bottom:70px;">REQUEST FOR A FREE ESTIMATE</h1>
            </div>
        </div>
                                    ...
                                    <div role=form class=wpcf7 id=wpcf7-f5-o1 lang=en-US dir=ltr>
                                        ...
                                        <form class="quform" action="process-qoute.php" method="post" enctype="multipart/form-data" onclick="">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6 col-sm-12">
                                                    <label class="qt-lable">Vehicle*</label>
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <label class="qt-lable">Special Instructions*</label>
